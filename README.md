...
To install `language-julia` search for _language-julia_ in the Install pane of the Lumine settings or run `lumine --install lumine-code/language-julia`.

## Services

- **hyperlink.injection** (`^1.0.0`): consumed to highlight URLs inside Julia files as clickable links.
